...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-rebus.numbers-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2367&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rebus.numbers-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rebus.numbers` can be installed with:

```
conda install r-rebus.numbers
```

It is possible to list all of the versions of `r-rebus.numbers` available on your platform with:
